...
<html>
	...
	<script>
		$(document).ready(function(){			
			...
			// {
			?>
				$('#rtable_length').html('Role&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="roleaddpopup()" >Add</a>');
			<?php
			// }
			// else
			// {
					...
					<div class="col__2">
						<div class="admninn__pagecontent">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><?php echo ucwords($role['role']); ?></td>							
												<?php
												// if(in_array(24, $this->session->userdata('function')))
												// {
												?>
													<td class="last__column">
														<a href="javascript:void(0);" id="<?php echo $role['id']; ?>" onclick="roleeditpopup(this.id)" class="link__vmore">Edit</a>
													</td>
												<?php
												// }
												?>
							...
							else
							{
								...
								// {
									echo 'Data Not Found <a href="javascript:void(0);" style="text-decoration:underline;margin-left:10px;" onclick="roleaddpopup()" >Add Role</a>';
								// }
							}
							?>
						</div>
